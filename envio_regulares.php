	...
	///////INFORMACION SOLICITD DE BENEFICIO//////////////
		$jefe = $_POST['jefe'];
		//echo 'jefeee'.$jefe;
		$renov = $_POST['renov'];
		$horab = $_POST['horab'];
		...
		$esol = $_POST['esol'];
		$codigoA = $_POST['materiasp'];
		//echo "materias".$_POST['materias'];
		$materia2 = $_POST['mat2'];
		$proyecto2 = $_POST['proy2'];
		$codigo2 = $_POST['proyecto'];
		$tipo_solicitud = $_POST['tiposol'];
		$tipo2 = $_POST['tipo2'];
		$lapso_solicitud = $_POST['lapso_solicitud'];
		$fila_solicitud = $_POST['fila_solicitud'];
		...
		$nombre_ayu2 = $_POST['beneficioanterior'];
...
*/		
		...
		$tipoA = $conex->result[0][0];			

		if ($tipoA == $tipo_solicitud){
			$renov="S";
		} else {
			$renov="N";
		}
...
//ECHO "codigoA".$codigoA."<br>";
		$codigo1=substr($codigoA,0,6);
		$nombre2=substr($codigoA,7,50);
		$codigo1p=substr($codigo2,0,5);
		$nombre2p=substr($codigo2,6,250);
//echo $estatus_solicitud;
//echo "fila-solicitud".$fila_solicitud."tipo2".$tipo2."tipo-solicitud".$tipo_solicitud;

	//if (($fila_solicitud > 0) and (($tipo_solicitud != $tipo2) or ($codigo1 != $materia2) or ($codigo2 != $proyecto2) ) and ($estatus_solicitud == 1 or $estatus_solicitud == 0))
	//echo 'estatus '.$estatus_solicitud;
	if (($fila_solicitud > 0) and ($estatus_solicitud == 1 or $estatus_solicitud == 0) )
		{
//echo "entre en modificar".$fila_solicitud."tipo".$tipo_solicitud."otro".$tipo2;

		////////////////////////////////////////////////////////////////////////
		////// rutina para actualizar  la tabla AYU_sol_beneficio        //////
		//////////////////////////////////////////////////////////////////////
		if ($tipo_solicitud!= "1"){
			$codigo1="";
	    }
		...
		$horab= date("h:i:s A");
if ($jefe=='s'){
		$sql2  = "UPDATE AYU_SOL_BENEFICIO SET 
		tipo='$tipo_solicitud',
		fecha_estatus='$fecha_solicitud', 
		fecha_solicitud='$fecha_solicitud',
		c_asigna='$codigo1',
		proyecto='$codigo1p',
		hora='$horab',
		estatus='1'
		WHERE exp_e='$exp_e' and  lapso='$lapso_solicitud' ";
}
else{
		$sql2  = "UPDATE AYU_SOL_BENEFICIO SET 
		tipo='$tipo_solicitud',
		...
		proyecto='$codigo1p',
		hora='$horab'
		WHERE exp_e='$exp_e' and  lapso='$lapso_solicitud' and estatus='1' ";
		}
	//echo $sql2;
		$conex->ExecSQL($sql2,__LINE__,true);
		$modif = $conex->fmodif;
		//echo "Solicitud de Beneficio Actualizado  ".$modif;
		}
	if ($fila_solicitud == 0) {

		////////////////////////////////////////////////////////////////////////////
		////// rutina para insertar la informacion en la TABLA AYU_sol_beneficio////
		///////////////////////////////////////////////////////////////////////////
//echo "entre en insert";
		$horab= date("h:i:s A");

		$conex->iniciarTransaccion("Inicio transaccion: ".$exp_e." - ");
		$sqlent2  = "INSERT INTO AYU_SOL_BENEFICIO (exp_e,fecha_solicitud,estatus,tipo,lapso,fecha_estatus,renovacion,c_asigna,proyecto,hora) VALUES ('$exp_e', '$fecha_solicitud','$estatus_solicitud','$tipo_solicitud','$lapso_solicitud','$fecha_solicitud','$renov','$codigo1','$codigo1p','$horab') ";
	//echo $sqlent2;
		...
		$modif = $conex->fmodif;
	//echo "Solicitud de Beneficio Ingresado  ".$modif;			
			}
...
<table border="0" align="center" style="font-family:arial;width:900px;color:navy;font-weight:bold;">
	...
	<tr>   
   	...
   	<tr>   
        <td align="center">
			Reporte de Solicitud de Beneficio Econ&oacute;mico
        </td>
  	</tr>
</table>
...
<tr>
    <td>
		<font color= NAVY><B>Nombre: </font></B><br/>
		<span style="font-size:13px;padding-left:5px;"> 
		 <?php echo utf8_encode("$apellidos"); ?>&nbsp;
		 <?php echo utf8_encode("$apellidos2"); ?>&nbsp;
		 <?php echo utf8_encode("$nombres"); ?>&nbsp;
		 <?php echo utf8_encode("$nombres2"); ?></span>
    </td> 
	<td> 
...
<tr><tr></tr>
	<td colspan="5">
		<font color= NAVY><B> Direcci&oacute;n: </B></font><br/>
		<span style="font-size:13px;padding-left:5px;">
		<?php echo "$ciudad.&nbsp;$avenida.&nbsp;$urbanizacion"; ?></span><br/> 
	</td>
</tr>
</tr>
<tr><tr></tr>
    <td colspan="5">
		<font color=NAVY> <B>Correo Electr&oacute;nico Estudiantil: </font>&nbsp;
		<?php echo "$correo1"; ?></B><br/>
    </td>
</tr>
<tr><tr></tr>

	<td>
		<font color=NAVY> <B>Tipo de Solicitud: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
		<?php 
			switch ($tipo_solicitud){
				case 1:
					echo "Preparaduria <br>";
					echo "&nbsp".utf8_encode($nombre2);
					break;	
				case 9:
					echo "Ayudantia";
					break;
				case 8:
					echo "Asistente de Investigacion <br>";
				    echo "&nbsp".utf8_encode($nombre2p);
					break;
				default:
					$esol='';
				...
				switch ($renov){
				case 'S':
					$renovx="Renovacion(".$nombre_ayuBA.")";
					break;	
				default:
					$renovx="Nueva Solicitud";
			
			}
	 ?></span>
    </td>
	<td>
		<font color=NAVY> <B>Fecha: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$fecha_solicitud"; ?></span>
    </td>
		<td>
		<font color=NAVY> <B>Hora: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$horab"; ?></span>
    </td>
	<td>
...
<tr>
	<td>
		...
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$lapso_solicitud"; ?></span><br/>
    </td>
	<td>
		<font color=NAVY> <B>Condicion: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$renovx"; ?></span>
    </td>
	<td>
		<font color=NAVY> <B>Cta.Banco: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
...
<tr>
	<td>
		...
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$carrera"; ?></span><br/>
    </td>
	<td>
		<font color=NAVY> <B>Telefono: </B></font><br/>
		<span style="font-size:15px;padding-left:5px;">
		<?php echo "$celcod-$telf2"; ?></span><br/>
    </td>
</tr>
</tr>
</table>
