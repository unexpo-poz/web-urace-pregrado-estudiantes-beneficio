...
/////////////////////////////////////////////////////////////////////////////////////////////
		...
		with (document.valido)
		  {
			...
			switch (afro.value)
			{
				...
				case "AFROASIÁTICO": opcion=3;break;
				...
				case "AFROBRASILEÑO": opcion=8;break;
				...
				case "AFROESPAÑOL": opcion=17;break;
				default:
				//alert(afro.value);
			}
	...
	//////////////////VALIDACIONES/////////////////////////////
		...
		{
			error ++;
			//alert("Etnia Indígena")
			mnsag+= '- Etnia Indígena \n\n';
		}*/
		...
		if(pais_plantel.value == 0) 
		{
			...
			mnsag+= '- País de Ubicación del Plantel \n\n';
		}
		...
		if (pais_plantel.value == 232)//VENEZUELA
		{
			if (edo_plantel.value == 0)
			{
				...
				mnsag+= '- Estado de Ubicación del Plantel \n\n';
			}
			...
			if (codigoc_S_1.value == '')
			{
				...
				mnsag+= '- Ciudad de Ubicación del Plantel \n\n';
			}
			if (codigom_S_1.value == '')
			{
				error ++;
				//alert("Municipio de Ubicacion del Plantel")
				mnsag+= '- Municipio de Ubicación del Plantel \n\n';
			}
		...
		{
			error ++;
			//alert("Año de Egreso del Plantel")
			mnsag+= '- Año de Egreso del Plantel \n\n';
		}
		...
		{
			error ++;
			//alert("Título Obtenido")
			mnsag+= '- Título Obtenido \n\n';
		}
		/*
		if(promedioS.value == '') 
		{
		...
		*/
		...
		{
			error ++;
			//alert("Opción CNU para UNEXPO")
			mnsag+= '- Opción CNU para UNEXPO \n\n';
		}
		...
		*/
		...
		if(promedio_mate.value == '') 
		{
			...
			mnsag+= '- Prom.Matemática \n\n';
		}
		*/
	if (error == 1 )
		{ 
		mnsag1 = "Existe "+error+" campo vacío:  \n\n";
		alert(mnsag1+mnsag);
		//return true; 
		}
		...
		{			
			mnsag1 = "Existen "+error+" campos vacíos: \n\n";
			alert(mnsag1+mnsag);
			//return false;
 			//alert('campos vacios');
 		}
			...
			if (error >= 0)
				{
					if ((tipo == '1') && (error == 0))
					{
						envia=confirm('¿Está seguro que desea continuar?')
					}
						else if (tipo == '2') 
						{
						envia=confirm('Los campos vacíos deben ser completados la próxima vez que ingrese.\n\n¿Está seguro que desea guardar y salir?')
						}
							if(envia)
							{
							//alert(tipo);
...
///********************************************************************************************/////
		...
		*/
		...
		if (edoNacimiento == ""){//si ENT_FED, está vacio lo obliga 
