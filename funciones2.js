...
function beneficio(valor){
	...
	//////////////////VALIDACIONES/////////////////////////////
		...
		with(document.valido)
		{		
			//alert(tiposol.value+'-'+materiasp.value);
				if(tiposol.value=='')
					{
						error ++;
						//alert("Numero de integrantes del grupo familiar")
						mnsag+= '- Debe seleccionar tipos de beneficio a solicitar \n\n'; 
					}

			if((tiposol.value=='1') && (materiasp.value=='0')) // valida que debe colocar una asignatura
			{
				error ++;
				//alert("Numero de integrantes del grupo familiar")
				mnsag+= '- Debe seleccionar una asignatura para preparaduria'; 
			}
		
			if((tiposol.value=='8') && (proyecto.value=='0')) // valida que debe colocar una asignatura
			{
				error ++;
				//alert("Numero de integrantes del grupo familiar")
				mnsag+= '- Debe seleccionar una asignatura para preparaduria'; 
		...
		if (error >= 0)
				{
					if ((tipo == '1') && (error == 0))
					{
						envia=confirm('REVISAR SU NUM. TELEFONICO ,ESTA SEGURO QUE DESEA CONTINUAR???')
					}
						else if (tipo == '2')
						{
